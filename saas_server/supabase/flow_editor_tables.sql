...
-- tenant_id = cliente (isolamento: um tenant tem N assistentes).
-- Regra de negócio: 1 flow por assistente (a aplicação reutiliza flow existente;
-- opcional: migration_um_flow_por_assistente.sql para consolidar e constraint).
-- ============================================================================
